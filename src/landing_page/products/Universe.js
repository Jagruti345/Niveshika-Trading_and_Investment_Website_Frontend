    ...
    return ( 
        ...
        <div className="row text-center mb-5">
            ...
            <div className="col-4 p-3">
                <img src="media/images/smallcaseLogo (1).png" alt='Smallcase Logo' style={{width:"150px",paddingBottom:"20px"}}/>
                <p className='text-muted text-small'>Thematic investment platform</p>
            </div>
             <div className="col-4 p-3 mt-5">
                <img src="media/images/streakLogo (1).png" alt='Streak Logo' style={{width:"150px",paddingBottom:"20px"}}/>
                <p className='text-muted text-small'>Algo and strategy platform</p>
            </div>
             <div className="col-4 p-3 mt-5">
                <img src="media/images/sensibullLogo (1).svg" alt='Sensibull Logo' style={{width:"150px",paddingBottom:"20px"}}/>
                <p className='text-muted text-small'>Options trading platform</p>
            </div>
            <div className="col-4 p-3 mt-5 mb-3">
                <img src="media/images/zerodhaFundhouse (1).png" alt='Zerodha Fundhouse Logo' style={{width:"180px",paddingBottom:"20px"}}/>
                <p className='text-muted text-small'>Asset management</p>
            </div>
             <div className="col-4 p-3 mt-5 mb-3">
                <img src="media/images/goldenpiLogo (1).png" alt='GoldenPi Logo' style={{width:"150px",paddingBottom:"20px"}}/>
                <p className='text-muted text-small'>Bonds trading platform</p>
            </div>
             <div className="col-4 p-3 mt-5 mb-3">
                <img src="media/images/dittoLogo (1).png" alt='Ditto Logo' style={{width:"130px",paddingBottom:"20px"}}/>
