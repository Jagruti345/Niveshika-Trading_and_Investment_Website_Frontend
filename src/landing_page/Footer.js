...
function Footer() {
    return (
        <footer className='border-top bg-light pb-5' style={{backgroundColor:"#ececec"}}>
        <div className='container mt-5' >
            ...
            <p>Niveshika Broking Ltd.: Meber of NSE & BSE - SEBI Registration no.: INZ000031633 CDSL: Depository services through Niveshika Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Niveshika Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Niveshika Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@niveshika.com, for DP related to dp@niveshika.com. Please
          ...
          <p>
            ...
            claiming to be part of Niveshika and offering such services, please
