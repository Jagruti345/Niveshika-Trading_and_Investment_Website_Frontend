...
function CreateTicket() {
    ...
    <div className="container">
      ...
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening
        </h4>
        ...
        <a href="/" style={{textDecoration:"none" , lineHeight:"2.5"}}>NRI Acoount Opening</a><br />
        <a href="/" style={{textDecoration:"none" , lineHeight:"2.5"}}>Charges at Niveshika</a><br />
        <a href="/" style={{textDecoration:"none" , lineHeight:"2.5"}}>Niveshika IDFC First Bank 3-in-1 Account</a> <br />
        <a href="/" style={{textDecoration:"none" , lineHeight:"2.5"}}>Getting Started</a><br />
      </div>
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-user" aria-hidden="true"></i> Your Niveshika Account
        </h4>
      ...
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Niveshika Account
        </h4>
        <a href="/" style={{textDecoration:"none" , lineHeight:"2.5"}}>Margin/leverage, Product ad Order type</a><br /> 
      ...
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-window-maximize" aria-hidden="true"></i> Funds
        </h4>
      ...
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console
        </h4>
      ...
      <div className="col-4 p-5 mt-2 ">
        <h4 className="pb-5"><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin
        </h4>
